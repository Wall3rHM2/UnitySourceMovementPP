...
namespace Fragsurf.Movement {
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        [HideInInspector] public float camX;// Capsule doesn't work anymore; I'll have to figure out why some other time, sorry.
        ...
        private bool toggleNoclip = false;
        ...
        private void Update () {
            ...
            //Noclip
            if (Input.GetButtonDown("Noclip") && !toggleNoclip) {
                noclip = !noclip;
                _collider.enabled = !_collider.enabled;
                if (noclip) _moveData.velocity = new Vector3(0,0,0); 
                toggleNoclip = true;
                
            }
            if (Input.GetButtonUp("Noclip")) toggleNoclip = false;


            _moveData.cameraUnderwater = _cameraWaterCheck.IsUnderwater ();
            _cameraWaterCheckObject.transform.position = viewTransform.position;
            moveData.underwater = underwater;
            moveData.noclip = noclip;
