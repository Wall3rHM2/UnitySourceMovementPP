...
public class PlayerAiming : MonoBehaviour
{
	...
	private void Update()
	{
		...
		GameObject player = bodyTransform.gameObject;
		Fragsurf.Movement.SurfCharacter surfController = player.GetComponent<Fragsurf.Movement.SurfCharacter>();
		surfController.camX = realRotation.x; 
